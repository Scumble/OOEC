...
namespace OOECAPI.Controllers
{
    ...
    public class ExternalAuthController : Controller
    {
        ...
        public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<AppUser> userManager, Context appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
        {
        ...
        public async Task<IActionResult> Facebook([FromBody]FacebookAuthViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                await _appDbContext.Users.AddAsync(new User { IdentityId = appUser.Id, Location = "", Locale = userInfo.Locale, Gender = userInfo.Gender });
